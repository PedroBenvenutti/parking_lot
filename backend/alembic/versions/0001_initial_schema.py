...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("task_type_id", sa.Integer(), nullable=False),
        sa.Column(
            "effort", sa.Enum("moto", "carro", "caminhao", name="effort", native_enum=False, length=20), nullable=False
        ),
        sa.Column(
            "priority",
            sa.Enum("baixa", "media", "alta", "urgente", name="priority", native_enum=False, length=20),
            nullable=False,
        ),
        sa.Column("due_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column(
            "status",
            sa.Enum("patio", "estacionado", "concluido", name="carstatus", native_enum=False, length=20),
            nullable=False,
        ),
